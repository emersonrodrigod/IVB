...
function marker_message() {
    $.sticky('Drag marker to adjust position.', {
        autoclose : 5000, 
        position: "top-center", 
        type: "st-info"
    });
...
gebo_maps = {
    ...
    save_location: function() {
        ...
        location_add_form.on('click','button', function() {
            $('html,body').animate({
                scrollTop: location_table.offset().top
            }, 'fast');
            ...
            $.sticky("Location Successfuly Saved.", {
                autoclose : 5000, 
                position: "top-center", 
                type: "st-info"
            });
    ...
    drop_marker_search: function() {
        ...
        if(search_query != ''){
                ...
                marker: {
                    ...
                    callback: function(marker){
                        if(marker){
                            ...
                            clear_form();
                            $.sticky("No adress found. Try again.", {
                                autoclose : 5000, 
                                position: "top-center"
                            });
                        }
            ...
            clear_form();
            $.sticky("Please Enter Location Name.", {
                autoclose : 5000, 
                position: "top-center"
            });
        }
